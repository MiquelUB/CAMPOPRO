...
class Usuari(Base):
    ...
    permis_conduir = Column(String(50), nullable=True)
    domicili = Column(String(500), nullable=True)
    especialitat = Column(String(100), nullable=True)
    cap_de_grup_id = Column(UUID(as_uuid=True), ForeignKey("usuaris.id"), nullable=True)
