...
export default function BibliotecaDePlanols() {
  const [opacity, setOpacity] = useState(85);
  const [showToast, setShowToast] = useState(false);

  useEffect(() => {
    // Show toast after a delay as in original script
  ...
  return (
    <main className="relative pt-32 p-xl bg-surface min-h-screen">
      <nav className="mb-lg flex items-center text-xs text-on-surface-variant gap-xs">
        <Home className="w-[14px] h-[14px]" /><span>/</span><span className="hover:text-primary cursor-pointer">Dashboard</span>
      </nav>
      <div className="flex flex-col w-full">
          ...
          <div className="w-[400px] flex flex-col bg-surface-container-low rounded-xl shadow-sm border border-outline-variant/30 overflow-hidden">
            <div className="p-md space-y-md border-b border-outline-variant/30 bg-surface-container-highest/20">
              ...
              <div className="flex items-center bg-surface-container-lowest px-md py-sm rounded-lg border border-outline-variant focus-within:border-primary transition-all group shadow-sm">
                <Search className="text-outline group-focus-within:text-primary w-5 h-5" />
                  ...
                  <details className="group" open>
                    <summary className="flex items-center justify-between p-sm hover:bg-surface-container-high rounded-lg cursor-pointer transition-colors list-none">
                      <div className="flex items-center gap-sm">
                        <ChevronRight className="text-outline group-open:rotate-90 transition-transform w-5 h-5" />
                    ...
                    <div className="space-y-md">
                      <div className="space-y-2">
                        <div className="flex justify-between items-center text-data-tabular">
                          ...
                          <span id="opacity-val">{opacity}%</span>
                        </div>
                        <input className="w-full h-1 bg-surface-container-highest rounded-lg appearance-none cursor-pointer accent-primary" 
                  ...
                  <div className="pointer-events-auto bg-surface/90 backdrop-blur-md p-lg rounded-xl shadow-2xl border border-outline-variant/30 flex-1 max-w-4xl">
                    <div className="flex items-center justify-between mb-lg">
                      <div className="flex items-center gap-md">
                        <div className="w-10 h-10 rounded-full bg-secondary-container/20 flex items-center justify-center">
                          <FileEdit className="text-on-secondary-container w-5 h-5" />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-3 gap-md">
                      ...
                      <div className="group bg-surface-container-lowest p-md rounded-lg shadow-sm hover:shadow-md transition-all border border-transparent hover:border-primary/20">
                        ...
                        <div className="mt-md flex -space-x-2">
                          <div className="w-8 h-8 rounded border-2 border-white bg-surface-dim overflow-hidden">
                            <img className="w-full h-full object-cover" alt="trench" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB6IKRXNDgOKQB9Yyqh9-m_LyevoFimLyIxBL3UENbPsLhcXGAzVpfnEA5xA7caxnafa6PI5jybfIdf63S8CQ0rXL_Fe54hwHVIU7ruoLfcLEbVq-zatAKPRyUfyN6q6J865vD7BvMBnxbKtfyZS-qmK0Jyf9lbApPPLLc0_cwgzROSv8m-m__tNKqAIzLKwUgIZk90_yuyOEE1tSj7qtethiVA-MlmDYgtxsk3cpwI2Yge9kqaGJjl" />
                          </div>
                          <div className="w-8 h-8 rounded border-2 border-white bg-surface-dim overflow-hidden">
                            <img className="w-full h-full object-cover" alt="blueprint" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBMInZaMSytuGjRAcS08K9C4j3bWgFW2PIziQlztwPbROhVQrnUtO8ighDhuRAfm3Vz9KNAeVbe9ajqUQug2ic6ANMUTMHDzExDE46SXjx3nyTA_VOKy9O0-bWUBm7c8blzaq4Gni9njZpVXaO7CZroe2ex8UF-uS-dy-UVBHmoRyP5kvLNQsZbdQyF9wjBtEynj8tt9ObpBAiRgbK1Nm_8zkVB0tkXrUI_a__6igZyNmZl9q4py5jn" />
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className={`fixed bottom-lg right-lg z-50 bg-inverse-surface text-inverse-on-surface px-xl py-md rounded-xl shadow-2xl flex items-center gap-md transform transition-transform duration-300 ${showToast ? 'translate-y-0' : 'translate-y-20'}`} id="status-toast">
          <CheckCircle className="text-secondary-container w-5 h-5" />
          <div className="flex flex-col">
          ...
          <button className="ml-md hover:bg-white/10 p-1 rounded" onClick={() => setShowToast(false)}>
