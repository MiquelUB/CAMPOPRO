...
export default function FeinesCompletadesPage() {
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-outline-variant/10">
                ...
                <tr className={`bg-surface-container-low/30 overflow-hidden transition-all duration-300 ${expandedRow === 'row-1' ? 'table-row' : 'hidden'}`} id="row-1-details">
                      ...
                      <div className="col-span-4 flex flex-col gap-md">
                        ...
                        <div className="relative group h-48 rounded-xl overflow-hidden shadow-md">
                          <img 
                            ...
                            alt="Close-up professional photograph of an agricultural irrigation valve system recently installed, late afternoon sun casting long shadows, metallic textures, droplets of water, shallow depth of field, high-tech farming aesthetic." 
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDveK6D5zSYaS6w84E8FKBzPqWfWi6ig_7O0OisKvLCxFUZEQSEMY2Q287y5gtDwEURl_0VNgQ3KdsD8PF5jutaTe5wAcCe9nEnIsCrTnMLaDixIlkBHW3pXaixoit-9sIcPZUaDIDJcZiM98vj12GrFpPzORVVsuPPktOg2uuMZ2uPh7XhTVOkNCYJ-uvy6Zuj0sXUYMEFSZ96zeB0bQ3DD0-tKisvHiisof2tnz6O6FUYqRvlMDI6"
                          />
                          ...
                          <div className="absolute inset-y-0 left-0 flex items-center p-xs opacity-0 group-hover:opacity-100 transition-opacity">
                            <button className="bg-white/20 backdrop-blur-md p-xs rounded-full text-white"><ChevronLeft size={20} /></button>
                          </div>
                          <div className="absolute inset-y-0 right-0 flex items-center p-xs opacity-0 group-hover:opacity-100 transition-opacity">
                            <button className="bg-white/20 backdrop-blur-md p-xs rounded-full text-white"><ChevronRight size={20} /></button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-span-4 flex flex-col gap-md">
                        ...
                        <div className="flex flex-col gap-sm">
                          <div className="h-32 bg-surface-container-highest rounded-xl relative border border-outline-variant/30 flex items-center justify-center group overflow-hidden">
                            <div className="absolute inset-0 grayscale contrast-125 opacity-30" data-location="Lleida, Spain" style={{}}></div>
                            <MapIcon className="text-primary text-4xl relative z-10" size={36} />
                      ...
                      <div className="col-span-4 flex flex-col gap-md">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[10px] text-error font-bold flex items-center gap-xs">
                            <TrendingUp size={12} /> +12.4% Desviació
                          </span>
                        </div>
                ...
                <tr className="hover:bg-surface-container-low/50 transition-colors cursor-pointer group">
                  ...
                  <td className="px-lg py-md text-right">
                    <div className="flex items-center justify-end gap-sm opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="p-xs hover:bg-surface-container-highest rounded text-on-surface-variant">
                        <FileText size={20} />
                      </button>
                      <button className="p-xs hover:bg-surface-container-highest rounded text-on-surface-variant">
                        <ChevronDown size={20} />
