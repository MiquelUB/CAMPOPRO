          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-outline-variant/10">
                {/* Row 1 */}
                <tr className="hover:bg-surface-container-low/50 transition-colors cursor-pointer group" onClick={() => toggleRow('row-1')}>
                  ...
                  <td className="px-lg py-md text-right">
                    <div className="flex items-center justify-end gap-sm opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button className="p-xs hover:bg-surface-container-highest rounded text-on-surface-variant" title="Detalls">
                        <span className="material-symbols-outlined">{expandedRow === 'row-1' ? 'expand_less' : 'expand_more'}</span>
                      </button>
                    </div>
                  </td>
                </tr>
                ...
                {expandedRow === 'row-1' && (
                  <tr className="bg-surface-container-low/30 overflow-hidden">
                      ...
                      <div className="grid grid-cols-12 gap-xl">
                        ...
                        <div className="col-span-4 flex flex-col gap-md">
                          ...
                          <div className="relative group h-48 rounded-xl overflow-hidden shadow-md">
                            <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDveK6D5zSYaS6w84E8FKBzPqWfWi6ig_7O0OisKvLCxFUZEQSEMY2Q287y5gtDwEURl_0VNgQ3KdsD8PF5jutaTe5wAcCe9nEnIsCrTnMLaDixIlkBHW3pXaixoit-9sIcPZUaDIDJcZiM98vj12GrFpPzORVVsuPPktOg2uuMZ2uPh7XhTVOkNCYJ-uvy6Zuj0sXUYMEFSZ96zeB0bQ3DD0-tKisvHiisof2tnz6O6FUYqRvlMDI6" />
                        ...
                        <div className="col-span-4 flex flex-col gap-md">
                          ...
                          <div className="flex flex-col gap-sm">
                            <div className="h-32 bg-surface-container-highest rounded-xl relative border border-outline-variant/30 flex items-center justify-center group overflow-hidden">
                              <div className="absolute inset-0 grayscale contrast-125 opacity-30" style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuDKWndsRtzpf1OCPI-wCnYbSWbN0MUPFGXnHLQzjg8Rj5XCkpNTdHjWU2VvgxoGjiia3Ir8solkDwPni9mtQXpZu0ZQuGv1jEslYc4OtvZQ0NtlII-Tn5aSvkB_RLtCjQ-TCE4xGZ6zd5xTP3uDzAax5e4bhKD18mSfBF0TjpPxiof0ZjCeqDrqRo97_sRZ1MAzPcbrxMXKxR51ik8-KVb0mI3A5DrFGM-BnNZsP_673c62scm83lFL')` }}></div>
                ...
                {/* Row 2 */}
                <tr className="hover:bg-surface-container-low/50 transition-colors cursor-pointer group" onClick={() => toggleRow('row-2')}>
                ...
                {/* Row 3 */}
                <tr className="hover:bg-surface-container-low/50 transition-colors cursor-pointer group" onClick={() => toggleRow('row-3')}>
