...
const HISTORIAL_TREBALLS_REALITZATS = [
  ...
  },
  {
    ...
    lat: 41.6540,
    lng: 1.8350,
    locationPresetName: 'Caseta de Bombes Central'
  }
];
...
function CreateJobForm() {
  ...
  // CONFIGURABLE GPS COORDINATES FOR OPERARI LOCATION
  ...
  // Handle Client Switch & Reset GPS
