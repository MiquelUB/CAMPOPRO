        ...
        <div className="flex items-center justify-between gap-lg mb-lg">
          <div className="flex items-center gap-md">
            ...
            <div className="flex bg-surface-container-high rounded-lg p-xs">
              <button 
                onClick={() => setFilter('TOTS')}
                className={`px-md py-xs rounded-md font-label-caps transition-all ${filter === 'TOTS' ? 'bg-surface-container-lowest shadow-sm text-primary' : 'text-on-surface-variant hover:text-primary'}`}
              >
                TOTS
              </button>
              <button 
                onClick={() => setFilter('ACTIUS')}
                className={`px-md py-xs rounded-md font-label-caps transition-all ${filter === 'ACTIUS' ? 'bg-surface-container-lowest shadow-sm text-primary' : 'text-on-surface-variant hover:text-primary'}`}
              >
                ACTIUS
              </button>
              <button 
                onClick={() => setFilter('INCIDÈNCIES')}
                className={`px-md py-xs rounded-md font-label-caps transition-all ${filter === 'INCIDÈNCIES' ? 'bg-surface-container-lowest shadow-sm text-primary' : 'text-on-surface-variant hover:text-primary'}`}
              >
                INCIDÈNCIES
              </button>
            </div>
