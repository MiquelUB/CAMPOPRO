...
export default function MapaEnTempsReal() {
  return (
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center justify-between gap-lg mb-lg">
          <div className="flex items-center gap-md">
            <div className="bg-surface-container-low border border-outline-variant rounded-lg px-md py-sm flex items-center gap-sm">
              <Calendar className="w-[18px] h-[18px] text-outline" />
          ...
          <div className="flex items-center gap-md">
            <div className="relative group">
              ...
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-outline w-[20px] h-[20px]" />
            </div>
        ...
        <div className="grid grid-cols-4 gap-lg mt-lg">
          <div className="bg-surface-container-low p-lg rounded-xl flex items-center justify-between border border-surface-container-highest">
            ...
            <Users className="text-primary-container w-[36px] h-[36px] opacity-20" />
          </div>
          ...
          <div className="bg-surface-container-low p-lg rounded-xl flex items-center justify-between border border-surface-container-highest">
            ...
            <Fuel className="text-primary-container w-[36px] h-[36px] opacity-20" />
          </div>
          ...
          <div className="bg-surface-container-low p-lg rounded-xl flex items-center justify-between border border-surface-container-highest">
            ...
            <Timer className="text-primary-container w-[36px] h-[36px] opacity-20" />
          </div>
