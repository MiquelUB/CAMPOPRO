...
<div className="absolute left-0 right-0 h-1 bg-secondary-container/50 shadow-[0_0_15px_rgba(254,147,44,0.8)] z-10" id="scanner-line"></div>
...
<input className="w-full h-14 bg-surface-container-low rounded-2xl pl-12 pr-14 font-headline-md text-headline-md text-primary outline-none focus:ring-0" readonly="" type="text" value="145.832"/>
<button className="absolute inset-y-0 right-2 w-12 flex items-center justify-center text-on-surface-variant active:scale-95 transition-transform">
<span className="material-symbols-outlined">edit</span>
</button>
</div>
<p className="text-[12px] text-on-surface-variant px-1">Capturat automàticament fa 2 segons</p>
</div>
<button className="w-full h-[72px] bg-secondary-container text-on-secondary-fixed font-headline-md text-headline-md rounded-2xl flex items-center justify-center gap-3 shadow-lg active:scale-[0.98] transition-all">
