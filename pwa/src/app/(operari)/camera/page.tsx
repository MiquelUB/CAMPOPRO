...
<span className="font-label-bold text-label-bold" id="timestamp">14 DE MAIG, 2024 • 11:24:02</span>
</div>
</div>
</div>
...
<button className="px-6 py-2 rounded-full font-label-bold text-label-bold text-white/60 transition-all active:scale-95" onClick={() => { /* selectState(this) */ }}>INICIAL</button>
<button className="px-6 py-2 rounded-full font-label-bold text-label-bold text-white/60 transition-all active:scale-95" onClick={() => { /* selectState(this) */ }}>DURANT</button>
<button className="px-6 py-2 rounded-full font-label-bold text-label-bold bg-secondary text-primary transition-all shadow-lg scale-105" onClick={() => { /* selectState(this) */ }}>FINAL</button>
</div>
</div>
{/* Main Action Row */}
...
<button className="w-20 h-20 bg-white rounded-full shadow-[0_0_30px_rgba(255,255,255,0.4)] active:scale-90 active:bg-surface-container-high transition-all flex items-center justify-center" id="capture-btn">
