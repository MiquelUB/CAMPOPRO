...
<span className="font-headline-md text-headline-md text-primary">3 Articles</span>
</div>
...
<div className="bg-primary h-full rounded-full w-[45%]" id="progress-tub"></div>
</div>
<span className="font-label-bold text-label-bold text-primary">45 / 100m</span>
</div>
<div className="flex items-center justify-between bg-surface-container-lowest rounded-lg p-2 mt-2">
<button className="w-12 h-12 flex items-center justify-center bg-surface-container-high rounded-lg active:bg-outline-variant transition-colors" onClick={() => { /* decrement('qty-tub') */ }}>
<span className="material-symbols-outlined">remove</span>
</button>
<div className="flex flex-col items-center">
<span className="font-headline-lg text-headline-lg text-primary" id="qty-tub">45</span>
<span className="font-label-bold text-[10px] text-on-surface-variant uppercase">Metres</span>
</div>
<button className="w-12 h-12 flex items-center justify-center bg-surface-container-high rounded-lg active:bg-outline-variant transition-colors" onClick={() => { /* increment('qty-tub') */ }}>
...
<div className="flex items-center justify-between bg-surface-container-lowest rounded-lg p-2 mt-2">
<button className="w-12 h-12 flex items-center justify-center bg-surface-container-high rounded-lg active:bg-outline-variant transition-colors" onClick={() => { /* decrement('qty-valv') */ }}>
<span className="material-symbols-outlined">remove</span>
</button>
<div className="flex flex-col items-center">
<span className="font-headline-lg text-headline-lg text-primary" id="qty-valv">2</span>
<span className="font-label-bold text-[10px] text-on-surface-variant uppercase">Unitats</span>
</div>
<button className="w-12 h-12 flex items-center justify-center bg-surface-container-high rounded-lg active:bg-outline-variant transition-colors" onClick={() => { /* increment('qty-valv') */ }}>
<span className="material-symbols-outlined">add</span>
</button>
</div>
</div>
...
{/* Add Material Button */}
<button className="flex items-center justify-center gap-2 py-4 bg-surface-container-highest rounded-xl text-primary font-button-text text-button-text active:scale-95 transition-transform" onClick={() => { /* toggleModal(true) */ }}>
...
{/* Save Action */}
<button className="w-full h-14 bg-secondary text-on-secondary rounded-xl font-button-text text-button-text flex items-center justify-center gap-2 shadow-lg active:scale-95 transition-transform mb-8">
<span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>save</span>
      GUARDAR CONSUM
    </button>
</div>
{/* Warehouse Search Modal */}
<div className="hidden fixed inset-0 z-[60] flex items-end" id="search-modal">
<div className="absolute inset-0 bg-primary/40 backdrop-blur-sm" onClick={() => { /* toggleModal(false) */ }}></div>
...
<button className="p-2 text-on-surface-variant" onClick={() => { /* toggleModal(false) */ }}>
...
<div className="p-4 bg-surface-container rounded-xl flex items-center justify-between active:bg-primary-fixed transition-colors">
