...
<div className="hidden flex items-start gap-3 p-4 mb-stack-md bg-error-container rounded-xl animate-pulse" id="warning-banner">
<span className="material-symbols-outlined text-error">warning</span>
<div className="flex flex-col">
<span className="font-label-bold text-label-bold text-on-error-container">Alerta de Material</span>
<p className="font-body-md text-body-md text-on-error-container">S'ha notificat una eina danyada. Es generarà un tiquet de reposició automàticament.</p>
</div>
</div>
{/* Tools List */}
...
<img className="w-full h-full object-cover" data-alt="A heavy duty industrial cordless drill, DeWalt style, professional photography, studio lighting, neutral background, high contrast, industrial tool." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBDwx_rg4v55zzNmp1zoZoiFnT48tqsdLnKI6ff1NtxdtRVZGx2JgBohxhrDAHto4njhKB_J2K4RIqrUqGkObpJAYEWPU-ZL04muWIuehOeUQxmfdxfSDFDUtH_Khpjhs71a0zGIF0T6rVN5FEC841LDEThy4Xh1FlIEqY2AefzRKk-Ga8sgNVLhJWbdVbMJinEOByfZuXEeM3n253INZ4SugVjQiVhX2H8rfAizAidvwYv5WVbscQ1"/>
</div>
<div className="flex-1 min-w-0">
<h3 className="font-label-bold text-body-md text-on-surface truncate">Berbiquí Elèctric Hilti</h3>
<span className="font-body-md text-label-bold text-on-surface-variant">ID: #44092-B</span>
</div>
</div>
<div className="relative">
<select className="appearance-none w-full h-touch-target-min px-4 bg-surface-container-highest rounded-lg font-button-text text-on-surface-variant focus:text-primary outline-none transition-all" onChange={() => { /* updateStatus(this) */ }}>
...
<div className="flex items-center gap-4">
<div className="w-16 h-16 rounded-lg bg-surface-container-highest flex items-center justify-center overflow-hidden">
<img className="w-full h-full object-cover" data-alt="A professional laser level kit on a tripod, precision engineering equipment, vibrant orange and black, construction site background blurred, professional photography." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCtn24057PEoJIWD6yPXaI5kjLJ-wCK5mKhR8hzYZf6gHrPOlTm7C9f-AyfpNxse4S7WGJNsa7bAHKeebxYJrR3-e1CKRcv5LeroJnHQcD3r8MoLvHVJPzjuo9NVIkZG9K7ZgOHHdlzcLg97O2eoF5lrWolUVF3H3CWU5LGzQmIy6pWYZt8Cr4LRDTND1M6q_xpcARSIMLmohxWxYgETBu95DJ9dXxipoirQ_TYGfkWl4bbMnAELLhW"/>
</div>
<div className="flex-1 min-w-0">
<h3 className="font-label-bold text-body-md text-on-surface truncate">Nivell Làser Pro</h3>
<span className="font-body-md text-label-bold text-on-surface-variant">ID: #88211-L</span>
</div>
</div>
<div className="relative">
<select className="appearance-none w-full h-touch-target-min px-4 bg-surface-container-highest rounded-lg font-button-text text-on-surface-variant focus:text-primary outline-none transition-all" onChange={() => { /* updateStatus(this) */ }}>
...
<div className="flex items-center gap-4">
<div className="w-16 h-16 rounded-lg bg-surface-container-highest flex items-center justify-center overflow-hidden">
<img className="w-full h-full object-cover" data-alt="A set of professional chrome vanadium wrenches in a roll-up tool organizer, metallic textures, high quality craftsmanship, workshop setting, sharp focus." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAt7-FxRzIzayCCTb0LC0E0dHz7l6nZEiBTDR5QZa04jXVZxx3F9BgYpWf8pk-wWI62ILVtsKvov5rYmeQ-rqvsmSNMoC8vYOXkbB1_0mwgRvs5GqfDZPbJ-60xQECTo_eZrvwsHHSwWrxPjJduAE6tVvmExz8GK0Nb6J3N1JepcCVtZ0hMJ2O8Xgc0g6sSIUWAff50vRACgZIBfY3SzZ2nfY_FSKiRjk5V65WfZPCmyy25tDM2LH6w"/>
</div>
<div className="flex-1 min-w-0">
<h3 className="font-label-bold text-body-md text-on-surface truncate">Joc de Claus Fixes</h3>
<span className="font-body-md text-label-bold text-on-surface-variant">ID: #10293-J</span>
</div>
</div>
<div className="relative">
<select className="appearance-none w-full h-touch-target-min px-4 bg-surface-container-highest rounded-lg font-button-text text-on-surface-variant focus:text-primary outline-none transition-all" onChange={() => { /* updateStatus(this) */ }}>
...
{/* Finalize Button */}
<button className="mt-stack-lg w-full h-16 bg-secondary-container text-on-secondary-fixed font-button-text text-button-text rounded-2xl flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-lg" id="finish-day-btn">
