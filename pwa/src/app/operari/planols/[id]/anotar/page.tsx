...
<div className="w-full h-full transition-transform duration-200 ease-out origin-center" id="blueprint-zoom-wrapper">
...
<button className="w-12 h-12 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-lg active:scale-95 transition-transform" onClick={() => { /* zoom(1.2) */ }}>
<span className="material-symbols-outlined">add</span>
</button>
<button className="w-12 h-12 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-lg active:scale-95 transition-transform" onClick={() => { /* zoom(0.8) */ }}>
...
<button className="flex-1 h-24 flex flex-col items-center justify-center gap-2 bg-surface-container-high rounded-xl text-primary active:bg-primary-fixed transition-colors" onClick={() => { /* this.nextElementSibling.classList.remove('hidden'); this.classList.add('hidden') */ }}>
<span className="material-symbols-outlined text-3xl">add_a_photo</span>
<span className="font-button-text text-button-text">Foto del canvi</span>
</button>
{/* Hidden by default, shown on click to simulate capture */}
<div className="hidden relative w-32 h-24 rounded-xl overflow-hidden shadow-sm group">
...
<button className="absolute top-1 right-1 bg-error text-on-error rounded-full p-0.5 shadow-md">
...
<textarea className="w-full p-4 bg-surface-container-low rounded-xl text-on-surface font-body-md focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline" id="observation" placeholder="Descriu la modificació realitzada respecte al plànol original..." rows="4"></textarea>
</div>
{/* Submit Button */}
<button className="w-full h-14 bg-[#008080] text-white rounded-xl font-button-text text-button-text shadow-lg active:scale-[0.98] transition-transform flex items-center justify-center gap-2">
