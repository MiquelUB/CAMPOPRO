        ...
        <div className="flex flex-col w-full pb-stack-lg">
          ...
          <div className="px-margin-mobile flex items-center justify-between mb-stack-md bg-surface-container-low py-4 shadow-sm">
            <div className="flex flex-col">
              ...
              <div className="font-headline-lg text-headline-lg text-secondary tabular-nums" id="job-timer">
                {formatTimer()}
              </div>
            </div>
          ...
          <div className="px-margin-mobile mb-stack-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Foto */}
              <button onClick={() => router.push('/operari/camera')} className="flex flex-col items-center justify-center aspect-square bg-primary-container rounded-2xl shadow-sm active:scale-95 transition-transform">
              ...
              {/* Material */}
              <button onClick={() => router.push('/operari/material')} className="flex flex-col items-center justify-center aspect-square bg-surface-container-high rounded-2xl shadow-sm active:scale-95 transition-transform">
              ...
              {/* Incidència */}
              <button onClick={() => router.push('/operari/incidencies/nova')} className="flex flex-col items-center justify-center aspect-square bg-error-container rounded-2xl shadow-sm active:scale-95 transition-transform">
              ...
              {/* Plànol */}
              <button onClick={() => router.push('/operari/planols/1/anotar')} className="flex flex-col items-center justify-center aspect-square bg-surface-container-high rounded-2xl shadow-sm active:scale-95 transition-transform">
              ...
              {/* Notes */}
              <button onClick={() => router.push('/operari/feines/1/signatura')} className="flex flex-col items-center justify-center aspect-square bg-surface-container-high rounded-2xl shadow-sm active:scale-95 transition-transform">
                <div className="w-12 h-12 rounded-full bg-outline flex items-center justify-center text-white mb-2">
                  <span className="material-symbols-outlined">edit_note</span>
                </div>
                <span className="font-button-text text-button-text text-on-surface">Signatura</span>
              </button>
          ...
          <div className="px-margin-mobile mt-auto">
            <button onClick={() => router.push('/operari/feines/1/signatura')} className="w-full h-16 bg-[#2e7d32] text-white rounded-2xl flex items-center justify-center gap-3 shadow-xl active:scale-[0.98] transition-all">
