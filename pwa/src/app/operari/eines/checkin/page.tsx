      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-surface/80 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.04)] pt-safe">
        <div className="h-16 px-4 flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            <h1 className="font-headline-md text-headline-md text-primary">Check-in Eines</h1>
          </div>
      ...
      <main className="flex flex-col relative w-full pt-16 pb-32 bg-surface min-h-screen">
        <div className="flex flex-col w-full">
          ...
          <div className="px-margin-mobile pt-stack-lg pb-stack-md flex flex-col gap-1">
            <span className="font-label-bold text-label-bold text-outline uppercase tracking-wider">Finalització de Jornada</span>
            <h2 className="font-headline-lg text-headline-lg text-primary">Retorn d'Eines al Magatzem</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">Verifica que no et deixes cap eina al lloc de treball.</p>
          </div>
          ...
          <div className="px-margin-mobile mb-stack-md">
            <div className="bg-secondary-container/10 border border-secondary-container/30 p-4 rounded-xl flex items-start gap-3">
              ...
              <p className="text-body-md text-on-surface leading-tight">
                Marca cadascuna de les eines que tornes a dipositar al magatzem o a la furgoneta.
              </p>
            </div>
          </div>
          ...
          <div className="px-margin-mobile flex flex-col gap-stack-md">
            ...
            <div className="bg-surface-container-low p-4 rounded-xl flex justify-between items-center mt-2">
              <span className="font-label-bold text-on-surface-variant">Eines Retornades</span>
              <span className="font-headline-md text-primary">{Object.values(checkedTools).filter(Boolean).length} / 3</span>
            </div>
          </div>
